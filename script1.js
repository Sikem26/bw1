...
for (let i = 0; i < questBtn.length; i++) {
  questBtn[i].addEventListener("click", function(e) {
    event.preventDefault();
    
    let rispostaUtente = e.target.innerHTML
    elencoRisposte.push(rispostaUtente)
    verifica(indexVerifica)
    indexVerifica++
...
//punteggioFinale = document.querySelector("#risultato").innerHTML
